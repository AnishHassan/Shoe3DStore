...
import hexStrings from "./Colors";

// Global-vars:
const fullCircle = 2 * Math.PI;
const quarterCircle = fullCircle / 4;

class ColourWheelCustom extends Component {
  constructor() {
    super();
...
ColourWheelCustom.defaultProps = {
  colours: hexStrings,
  shades: 24,
  padding: 0,
  dynamicCursor: true,
...
export default ColourWheelCustom;
